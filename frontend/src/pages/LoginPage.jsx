      ...
      <div className="hidden lg:flex lg:w-1/2 bg-linear-to-br from-neutral-50 to-white items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="relative">
            ...
            <div className="absolute top-20 -right-10 text-6xl text-neutral-200 font-bold opacity-50">
              %
            </div>
            <div className="absolute -bottom-10 -left-20 text-7xl text-neutral-200 font-bold opacity-50">
              $
            </div>
